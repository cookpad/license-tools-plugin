...
## v0.19.1
- [Fix warning in Gradle 3.0](https://github.com/cookpad/license-tools-plugin/issues/34)

## v0.19.0
- [Compare LibraryInfo by artifactId or filename](https://github.com/cookpad/license-tools-plugin/pull/32)
- [Support Eclipse Public License](https://github.com/cookpad/license-tools-plugin/pull/30)
- [Support Mozilla Public License](https://github.com/cookpad/license-tools-plugin/pull/30)
